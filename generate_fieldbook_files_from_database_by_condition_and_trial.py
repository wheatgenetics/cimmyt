...
cursorA.execute(fieldBookQuery, (fyear,flocation,ftrial,fcondition ))
print()
print("Number of records found for " + fyear + '-' + flocation  + '-' +  ftrial + '-' + fcondition + " = " +
...
outFile="Fieldbook_" + fyear + '-' + flocation + '-' + ftrial + '-' + fcondition +'.csv'
