#! /usr/bin/python
#
# Program: read_and_annotate_field_map_segregated_F6-F7.py
#
...
#
# N.B. F6-F7 plots for segregated populated have a different spreadsheet layout than other plots (in terms or where the
...
worksheet.set_column(1, 32, 30.0)
...
rowList=[]
#for row in range(numRows-1): # For F5I
